...
import (
	...
	"github.com/krateoplatformops/finops-operator-vm-manager/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dbd72dca.krateo.io",
	...
	if err = (&controller.ConfigManagerVMReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ConfigManagerVM")
		os.Exit(1)
	}
